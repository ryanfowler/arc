...
// characters outside supported host syntax, includes a port, or uses parameter
// syntax that Arc host patterns do not support.
//
// Host patterns registered with [Router.Host] and [Router.TryHost] must be a
// valid DNS host name, a colon-form host literal such as "::1", or a host name
// with parameters such as "{tenant}.example.com", "api-{region}.example.com",
// or "{*subdomain}.example.com". Host patterns are matched against the whole
